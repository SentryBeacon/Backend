# 📸 SeantryBeacon: Hệ Thống AI Phát Hiện Vi Phạm Làn Đường
...
## 📑 Mục Lục
- [1. Tầm Nhìn Dự Án](#1-tầm-nhìn-dự-án)
- [2. Hệ Giá Trị Công Nghệ (Tech Stack Analysis)](#2-hệ-giá-trị-công-nghệ-tech-stack-analysis)
- [3. Kiến Trúc Luồng Dữ Liệu (Pipeline Architecture)](#3-kiến-trúc-luồng-dữ-liệu-pipeline-architecture)
- [4. Các Điểm Sáng Kỹ Thuật (Strategic Advantages)](#4-các-điểm-sáng-kỹ-thuật-strategic-advantages)
- [5. Bằng Chứng Thực Nghiệm (Evidence Case Studies)](#5-bằng-chứng-thực-nghiệm-evidence-case-studies)
- [6. Hướng Dẫn Vận Hành & Tương Tác](#6-hướng-dẫn-vận-hành--tương-tác)
- [7. Cấu Trúc Cơ Sở Dữ Liệu Bằng Chứng](#7-cấu-trúc-cơ-sở-dữ-liệu-bằng-chứng)
...
**Mục tiêu cốt lõi:**
- **Kỷ luật hóa giao thông**: Phát hiện lấn làn với độ trễ gần như bằng không.
- **Minh bạch hóa bằng chứng**: Chụp và lưu trữ hình ảnh hiện trường cùng ID định danh duy nhất.
- **Độ tin cậy tuyệt đối**: Sử dụng Kalman Filter để "nhìn xuyên" qua các khoảnh khắc mất dấu tạm thời.

---

## 🛠️ 2. Hệ Giá Trị Công Nghệ (Tech Stack Analysis)

Chúng tôi lựa chọn những công nghệ hàng đầu để đảm bảo sự cân bằng giữa **Độ chính xác** và **Tốc độ xử lý**.
...
> [!TIP]
> **Tại sao là YOLOv8m?**
> Chúng tôi chọn phiên bản `m` (medium) thay vì `n` (nano) để bắt được chi tiết các loại xe ở khoảng cách 50m-100m, nơi mà các model nhỏ hơn thường bị nhầm lẫn giữa bóng xe và vật thể thực.

---

## ⚙️ 3. Kiến Trúc Luồng Dữ Liệu (Pipeline Architecture)
...
Tập trung tối đa tài nguyên cho việc phát hiện và theo dõi hành vi vi phạm ở tốc độ khung hình cao nhất, đảm bảo tính ổn định của hệ thống.

---

## 📊 5. Bằng Chứng Thực Nghiệm (Evidence Case Studies)

Kết quả vận hành thực tế cho thấy sự chính xác trong việc ghi nhận hành vi và trích xuất đặc điểm phương tiện.

### 🚗 Case Alpha: Phương Tiện ID 6 (Xe Sedan Đen)
- **Tình huống**: Phương tiện đi thẳng vào tâm vùng cấm, quỹ đạo di chuyển song song với dải phân cách.
- **Dữ liệu ghi nhận**: Hệ thống tự động chọn khung hình có góc quan sát tốt nhất cho việc xác định hãng xe và màu sắc.
...
<div align="center">
  ...
  <br>
  <i>Ảnh 5.1: Hiện trường vi phạm với nhãn ID và trạng thái VIOLATED.</i>
  <br><br>
  <img src="images/vp_0002_id6_20260416_233801_457_best.jpg" alt="Case Alpha Crop" height="180" style="border: 1px solid #ddd;"/>
  <br>
  <i>Ảnh 5.2: Khung hình "Best Frame" trích xuất từ bộ đệm chuyển động.</i>
</div>

---

### 🚙 Case Beta: Phương Tiện ID 5 (Xe Sedan Trắng)
- **Tình huống**: Phương tiện di chuyển ở tốc độ cao trong làn xe buýt.
- **Dữ liệu ghi nhận**: Dù ở khoảng cách xa, Kalman Filter vẫn duy trì bám đuổi ID ổn định.
...
<div align="center">
  ...
  <br>
  <i>Ảnh 5.3: Ghi nhận vi phạm tại làn đường.</i>
  <br><br>
  <img src="images/vp_0001_id5_20260416_233757_006_best.jpg" alt="Case Beta Crop" height="180" style="border: 1px solid #ddd;"/>
  <br>
  <i>Ảnh 5.4: Đặc điểm phương tiện được lưu trữ rõ nét dưới điều kiện ánh sáng mạnh.</i>
</div>

---

## 🏁 6. Hướng Dẫn Vận Hành & Tương Tác

Hệ thống cung cấp giao diện tương tác trực tiếp giúp người dùng dễ dàng cấu hình hiện trường.

### 🔌 Khởi chạy
- **Vẽ vùng cấu hình**: `python detector.py --draw` (Kéo thả chuột để định nghĩa vùng cấm).
- **Chạy thực tế**: `python detector.py --run --show` (Bật giao diện preview thời gian thực).

### 🖥️ Các Hotkeys trong preview
- `Q`: Thoát hệ thống an toàn, đảm bảo dữ liệu CSV được đóng đúng cách.
- `HUD Display`: Góc trên cùng bên trái hiển thị tổng số xe trong làn và tổng số ca vi phạm đã lưu.

---

## 📂 7. Cấu Trúc Cơ Sở Dữ Liệu Bằng Chứng
